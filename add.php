...
<fieldset>
    <form action="" method="post" name="" style="text-align-last: center">
      ...
      <input name="Boattypes" type="text" class="Input" placeholder="Enter the Boat type" required>  
      <br><br>
      <a align="right" style="color:#3399ff">Source</a><br>
      <input name="Boatsrc" type="text" class="Input" placeholder="Enter the Source" required>
      <br><br>
      <a align="right" valign="top" style="color: #3399ff">Destination </a><br>
      <input name="Boatdes" type="text" class="Input" placeholder="Enter the Destination" required>
      <br><br>
      <a align="right" style="color:#3399ff">Duration</a><br>
      <input name="Boatdur" type="text" class="Input" placeholder="Enter the Duration" required>
      <br><br>
      <a align="right" style="color:#3399ff">Seats</a><br>
      <input name="Boatseats" type="text" class="Input" placeholder="Enter the Seats" required>
      <br><br>
