...
<fieldset>
    <form action="" method="post" name="" style="text-align-last: center">
      ...
      <a colspan="2" align="center" valign="top" ><h3 >Enter To Search</h3></a><br><br>
    
    
      <a align="right" valign="top" style="color: #3399ff">Boat Type </a><br>
      <input name="search_Boattype" type="text" class="Input" placeholder="Enter the Boat Type" required>
      <br><br>


      <a align="right" valign="top" style="color: #3399ff">Boat Name </a><br>
      <input name="search_Boatname" type="text" class="Input" placeholder="Enter the Name" required>
      <br><br>
