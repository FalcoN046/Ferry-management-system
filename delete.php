...
<fieldset>
    <form action="" method="post" name="" style="text-align-last: center">
      ...
      <a colspan="2" align="center" valign="top" ><h3 >Enter Boat To Delete</h3></a><br><br>
    
    
      <a align="right" valign="top" style="color: #3399ff">Boat Type </a><br>
      <input name="delete_type" type="text" class="Input" placeholder="Enter the Boat Type" required>
      <br><br>

      <a align="right" valign="top" style="color: #3399ff">Boat Name </a><br>
      <input name="delete_name" type="text" class="Input" placeholder="Enter the Boat Name" required>
      <br><br>
    

      <input name="Submit" type="submit" value="Submit"  id= "submit" align="center" style="" class="Button3" style="color: #3399ff">
